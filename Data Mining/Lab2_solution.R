...
boxplot(carAuction[which(carAuction$IsBadBuy=='No'),]$VehBCost, main="Boxplot of VehBCost of NOT bad buy cars", ylab="VehBCost")
...
# Display the number of cars have different WheelType
table(carAuction$WheelType)

# Disply the proportion of cars have different WheelType
